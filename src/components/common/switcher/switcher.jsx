                  ...
                  <div className="theme-colors">
                    ...
                    <div className="d-flex switcher-style pb-2">
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Light Menu </Tooltip>}
                        >
                          <input
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Dark Menu</Tooltip>}
                        >
                          <input
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Color Menu</Tooltip>}
                        >
                          <input
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Gradient Menu</Tooltip>}
                        >
                          <input
                            ...
                            type="radio"
                            checked={
                              local_varaiable.dataMenuStyles == "gradient"
                            }
                            onChange={(_e) => {}}
                            onClick={() =>
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Transparent Menu</Tooltip>}
                        >
                          <input
                  ...
                  <div className="theme-colors">
                    ...
                    <div className="d-flex switcher-style pb-2">
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Light Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-white"
                            data-bs-toggle="tooltip"
                            ...
                            name="header-colors"
                            checked={
                              local_varaiable.dataHeaderStyles == "light"
                            }
                            onChange={(_e) => {}}
                            id="switcher-header-light"
                            onClick={() =>
                              switcherdata.lightHeader(ThemeChanger)
                            }
                          />
                        </OverlayTrigger>
                      </div>
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Dark Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-dark"
                            data-bs-toggle="tooltip"
                            ...
                            onChange={(_e) => {}}
                            onClick={() =>
                              switcherdata.darkHeader(ThemeChanger)
                            }
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Color Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-primary"
                            data-bs-toggle="tooltip"
                            checked={
                              local_varaiable.dataHeaderStyles == "color"
                            }
                            onChange={(_e) => {}}
                            type="radio"
                            onClick={() =>
                              switcherdata.colorHeader(ThemeChanger)
                            }
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Gradient Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-gradient"
                            data-bs-toggle="tooltip"
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Transparent Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-transparent"
                            data-bs-toggle="tooltip"
