...
const Sidebar = ({ local_varaiable, ThemeChanger }) => {
  ...
  function slideRight() {
    ...
    if (menuNav && mainContainer1) {
      ...
      const element =
        document.querySelector < HTMLElement > ".main-menu > .slide.open";
      const element1 =
        document.querySelector < HTMLElement > ".main-menu > .slide.open > ul";
      if (element) {
  ...
  function setMenuUsingUrl(currentPath) {
    // console.log(currentPath, MENUITEMS);
      ...
      if (
        ...
        if (newValue == "vertical") {
          let currentPath = location.pathname.endsWith("/")
            ...
            : location.pathname;
          currentPath = !currentPath ? "/crm/projects" : currentPath;
      ...
      >
        <div className="main-sidebar-header">
          ...
          >
            ...
            <img src={logo3} alt="logo" className="desktop-white" />
            <img src={logo4} alt="logo" className="toggle-white" />
          </Link>
        </div>
